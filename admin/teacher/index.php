...
$db=new Database;
$db->connect();
$result=$db->get_list('teacher','1 = 1');
$db->dis_connect();
?>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Danh sach giao vien</h1>
                    <?php include '../hepler/notify.php'; ?>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="http://localhost/web_student/admin">Home</a></li>
                        <li class="breadcrumb-item active">Teacher</li>
                        <li class="breadcrumb-item"><a href="http://localhost/web_student/admin/teacher/add.php">Them moi</a></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            { ?>
                            ...
                            {?>
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <?php if($_SESSION['level']=='1' || $_SESSION['id']==$row['id_account']) { ?>
                                    <a href=<?php echo 'detail.php?id='.$row['id_account']; ?> class="btn btn-info">Chi tiet</a>
                                    <?php } ?>
                                </td>
